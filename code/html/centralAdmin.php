...
<html>
    <head>
        ...
        <link rel="stylesheet" href="dist/css/centralAdmin.css">
        <script src="dist/js/centralAdmin.js"></script>
    ...
    <body>
        <?php if ($valid): ?>  
            <div id="container">
                <h1>Clientes para las centrales del sistema</h1>
                    ...
                    <tbody><?php
                        ...
                        for ($index = 0; $index < $indexCount; $index++) {
                            ...
                            if (substr("$dirArray[$index]", 0, 1) != $hide) {
                                ...
                                echo("
		<tr class='$class'>
			<td><a href='downloadScript.php?a=$namehref'>$name</a></td>
			<td><a href=''>$extn</a></td>
